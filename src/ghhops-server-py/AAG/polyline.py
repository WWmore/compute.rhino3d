...
from scipy.spatial import cKDTree as c_kDTree # by Hui
...
#------------------------------------------------------------------------------
    ...
    def make_kdtree(self):
        KDtree = c_kDTree(self.vertices) #Hui
        self._kdtree = KDtree
...
#------------------------------------------------------------------------------
    ...
    def cell_array(self, offset=0): # Hui: used in polylinesource.py
    ...
    # def cell_array(self): # Hui: add, for diagonal lines
